        ...
        <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 cursor-pointer">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="flex flex-col max-w-md mx-auto md-auto md:mx-0 justify-between rounded-b-xl shadow hover:shadow-lg transition-shadow">
                        <div className="flex-flex-col px-6 py-8 mb-10 space-y-5">
                            <svg
                                width="24"
                                height="18"
                                viewBox="0 0 24 18"
