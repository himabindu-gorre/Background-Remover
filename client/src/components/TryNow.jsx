    ...
    <div>
      <div className="flex flex-col items-center justify-center bg-white px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-10 flex flex-col items-center space-y-4">
            <input type="file" id='upload' hidden accept='image/*' onChange={(e) => removeBg(e.target.files[0])} />
            <label htmlFor="upload" 
            className='bg-indigo-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full text-lg'>
                Upload Image
            </label>
            <p className="text-gray-500 text-sm">
                or dropa a file, paste image or <a href="#" className='text-blue-500 underline'>URL</a>
            </p>
        </div>
      </div>
    </div>
